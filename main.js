...
module.exports = "<div class=\"article-content\">\n  <div class=\"container\">\n\n    <div class=\"row\">\n      <div class=\"col-lg-6 col-md-6 title2\">\n        <small>MY WORKS __________ </small>\n      </div>\n    </div>\n    <div class=\"row\">\n\n      <!-- web apps arr -->\n      <div *ngFor=\"let item of itemArray; let idx = index\" class=\"col-md-4 card2\"\n           data-toggle=\"modal\" [attr.data-target]=\"'#work' + idx\">\n        <img class=\"img-work\" src=\"\\assets\\img\\{{item.img_main}}\" data-toggle=\"tooltip\"\n             title=\"{{item.title}}\">\n      </div>\n      <!-- Modal -->\n      <div *ngFor=\"let item of itemArray; let idx = index\" class=\"modal fade\"\n           id=\"work{{idx}}\" tabindex=\"-1\" role=\"dialog\"\n           aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\">{{item.title}}</h5>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" >\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n            </div>\n            <div class=\"modal-body\">\n              <div id=\"carouselwork{{idx}}\" class=\"carousel slide\" data-ride=\"carousel\">\n                <div class=\"carousel-inner\">\n                  <div class=\"carousel-item\" *ngFor=\"let c_item of item.img_list; let c_idx = index\">\n                    <img class=\"img-work\" src=\"\\assets\\img\\{{c_item}}\" alt=\"slide{{c_idx}}\">\n                    <ul class=\"work-info\">\n                      <li>{{item.details_list[c_idx*2]}}</li>\n                      <li>{{item.details_list[c_idx*2+1]}}</li>\n                    </ul>\n                  </div>\n                  <div class=\"carousel-item active\">\n                    <div class=\"work-info\">\n                      <h6>Technologies</h6>\n                      <ul>\n                        <li *ngFor=\"let tech of item.technologies;\">{{tech}}</li>\n                      </ul>\n                      <h6>Last Updated</h6>\n                      <ul><li>{{item.last_updated}}</li></ul>\n                    </div>\n                  </div>\n                </div>\n                <a class=\"carousel-control-prev\" href=\"#carouselwork{{idx}}\" role=\"button\" data-slide=\"prev\">\n                  <span class=\"fa fa-chevron-circle-left\" aria-hidden=\"true\"></span>\n                </a>\n                <a class=\"carousel-control-next\" href=\"#carouselwork{{idx}}\" role=\"button\" data-slide=\"next\">\n                  <span class=\"fa fa-chevron-circle-right\" aria-hidden=\"true\"></span>\n                </a>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- websites arr -->\n      <div class=\"col-md-4 card2\" *ngFor=\"let item of websiteArray; let idx = index\">\n        <a href=\"{{item.link}}\" target=\"_blank\">\n          <img class=\"img-work\" src=\"\\assets\\img\\{{item.img_main}}\" alt=\"MY WORKS\" data-toggle=\"tooltip\"\n               title=\"{{item.title}}\">\n        </a>\n      </div>\n\n    </div>\n\n\n    <div class=\"row\">\n      <div class=\"col-lg-6 col-md-6 title2\">\n        <small>I CAN WORK WITH __________ </small>\n      </div>\n    </div>\n    <div class=\"row\">\n\n      <div class=\"col-md-2 col-lg-2\" *ngFor=\"let item of techArray; let idx = index\">\n        <img class=\"img-work2\" src=\"\\assets\\img\\tech_stack\\{{item}}.jpg\" alt=\"\" data-toggle=\"tooltip\"\n             title=\"{{item}}\" onmouseover=\"rotateYDIV(this)\">\n      </div>\n\n    </div>\n  </div>\n</div>\n"
...
var AboutComponent = /** @class */ (function () {
    ...
    AboutComponent.prototype.ngOnInit = function () {
        //web apps
        this.itemArray = [{ 'img_main': 'work5.png',
                'title': 'Personal File Manager for Gvt officers',
                'img_list': ['work5.png', 'work51.png', 'work52.png'],
                'details_list': ['Home page contains the routes for main functions in a establishment branch.',
                    'Font Awesome icons improves the UI user friendliness',
                    'Responsive & cross browser compatible UI implementation',
                    'Bootstrap CSS library in-build css classes, js functions supports',
                    'Generate list of printable reports without alignment issues & third party libraries',
                    'All these reports are easily customizable and extendable for client requirements'],
                'technologies': ['Php 7.4.26', 'CodeIgniter 3.1.11', 'Apache 2.4.51', 'MySQL 5.7.36',
                    'Bootstrap v4.1.1', 'Font Awesome Free 5.13.1'],
                'last_updated': '2021' },
            { 'img_main': 'work4.png',
                'title': 'Web app for employee Leave management',
                'img_list': ['work4.png', 'work41.png', 'work42.png'],
                'details_list': ['Landing page after login route displays the summery of user assigned leaves',
                    'Simple JS carousel builds the user friendly and modern UI',
                    'History page taken leaves with status and filter by leave type',
                    'Responsive UI improves the accessibility from different devices',
                    'Has two user authorization levels ',
                    'One user can apply for leave and his/her supervisor gives the feedback'],
                'technologies': ['Php 7.4.26', 'CodeIgniter 3.1.11', 'Apache 2.4.51', 'MySQL 5.7.36',
                    'Bootstrap v4.1.1', 'Font Awesome Free 5.13.1'],
                'last_updated': '2021' },
            { 'img_main': 'work6.png',
                'title': 'In-store food ordering app for a restaurant',
                'img_list': ['work6.png', 'work61.png', 'work62.png'],
                'details_list': ['User friendly menu page with basic details of each food item',
                    'Important to display high quality images to attract the customers',
                    'Only admin(ex. Manager) has authorized to see these details',
                    'Manager can improve the productivity and performance of processing food using these data',
                    'This is the details of a order from waiter/chef perspective while processing the food',
                    'He can shift the status of order using the button and display the processing time spend for each stage'],
                'technologies': ['Php 7.4.26', 'CodeIgniter 3.1.11', 'Apache 2.4.51', 'MySQL 5.7.36',
                    'Bootstrap v4.1.1', 'Font Awesome Free 5.13.1'],
                'last_updated': '2022' },
            { 'img_main': 'work9.png',
                'title': 'Minesweeper Puzzle game',
                'img_list': ['work9.png', 'work91.png', 'work92.png'],
                'details_list': ['Traditional Minesweeper game board that came with windows early versions ',
                    'Follows the best practices of design and implementation for javaFx apps ',
                    'Allows to change the UI theme at any stage',
                    'Appearance change feature is extendable with low cost to meet modern requirements',
                    'Has three levels based on size of the board, easy for modifications',
                    'number in a grid is the sum of mines which located in surrounding 9 grids'],
                'technologies': ['java 8', 'swing', 'javafx 1.8'],
                'last_updated': '2014' },
            { 'img_main': 'work8.png',
                'title': 'Matching three board game',
                'img_list': ['work8.png', 'work81.png', 'work82.png'],
                'details_list': ['Basic tile color matching board game ',
                    'Follows the best practices of design and implementation for javaFx apps',
                    'Use simple csv file for saving the score records',
                    'Simple integer arrays and for loops of java implements the game logic',
                    'user friendly UI generated by javaFx builder',
                    'Low cost extendability of the code allows adding more complex features'],
                'technologies': ['java 8', 'swing', 'javafx 1.8'],
                'last_updated': '2014' },
            { 'img_main': 'work10.png',
                'title': 'Sudoku Puzzle game',
                'img_list': ['work10.png', 'work101.PNG', 'work102.PNG'],
                'details_list': ['Famous sudoku puzzle game',
                    'Follows the best practices of design and implementation for javaFx apps',
                    'Extendable game levels based on size and complexity',
                    'Simple integer arrays and for optimized loops in java does the work nicely',
                    'Save the scores to see your progress',
                    'user friendly UI generated by javaFx builder'],
                'technologies': ['java 8', 'swing', 'javafx 1.8'],
                'last_updated': '2014' },
            { 'img_main': 'work12.PNG',
                'title': 'Merge Story',
                'img_list': ['work123.PNG', 'work121.PNG', 'work122.PNG'],
                'details_list': ['A simple Java Script version for merge games collection',
                    'Light Weight source code written only using html, css and java script',
                    'A board game with simple logic for players to have fun in small free times',
                    'two types of icons, as icon generators and basic icons',
                    'Basic icon selling is the main source of game level up',
                    'Icon orders will appear in random beside the game board.'],
                'technologies': ['html5', 'css3', 'javascript', 'bootstrap5'],
                'last_updated': '2024' }
        ];
        //websites
        this.websiteArray = [{ 'img_main': 'work71.PNG',
                'title': 'Static responsive website for small business.',
                'link': 'https://kaushi-stores.w3spaces.com' },
            { 'img_main': 'work3.png',
                'title': 'My personal tech blog',
                'link': 'https://piyumi11.github.io' }];
        //tech stack
        this.techArray = ['java', 'php', 'codeigniter', 'spring', 'angular', 'python',
            'html', 'css', 'javascript', 'bootstrap', 'jquery', 'javafx',
            'mysql', 'oracledb', 'mongodb', 'hibernate', 'innodb', 'mysql',
            'http', 'tomcat', 'lamp', 'xampp', 'glassfish', 'nodejs',
            'git', 'npm', 'gradle', 'Jenkins', 'Maven', 'docker',
            'uml', 'junit', 'jusmine', 'tcpdf', 'jmeter', 'opengl'];
    };
